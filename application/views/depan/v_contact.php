                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Lintas Nusantara Academy
                                        <br> Indonesia, BKS
                                        <br> Jl. Cut Mutia No.88, Sepanjang Jaya, Kec. Rawalumbu, Kota Bks, Jawa Barat 17113</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p>IDN@lintasnusantara.edu.ac
                                            <br>admin@lintasnusantara.edu.ac
                                        </p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
